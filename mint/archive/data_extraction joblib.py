...
def trajectory_calculations(phase_parameters,settings):
    ...
    intensity_GO,intensity_STOP,variance_GO,variance_STOP,curvilign_velocity,processivity,run_length,pausing_frequency,pausing_time,\
        diag_size,fraction_paused,moving_particles,moving_particles_msd,number_stop,duration,curv_length,pausing_time = ([] for _ in range(17))
...
if __name__ == '__main__':
    ...
    start = time.time()
    input_folder = Path(r"/media/lumin/SHG_tracking_data/Zebrafish data/test_mkl/124/")
