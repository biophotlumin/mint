...
def inst_velocity(x,y,parameters):
    ...
    :type y: NumPy array
    :param parameters: Dictionary containing the sampling period in seconds under the `'dt'` key.
...
def confinement(x,y,parameters):
    ...
    :param y: Array of y coordinates
    :type y: NumPy array
    :param parameters: Dictionary containing the confinement ratio sliding window under the `'sliding_window'` key.
    :type parameters: dict
...
def trajectory_calculations(phase_parameters,settings):
    ...
    if settings['antero_retro']:
        ...
        temp_dict = {'curvilign_velocity_antero':curvilign_velocity_antero,
                    'curvilign_velocity_retro':curvilign_velocity_retro,
